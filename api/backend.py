...
from routes.v2.collaboration import collaboration_bp  # Phase 4: Collaboration & Notifications
...
app.register_blueprint(collaboration_bp, url_prefix="/api")  # Phase 4: Collaboration
