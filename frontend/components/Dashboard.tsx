  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      tooltip: {
        ...
        titleColor: "#ffffff",
        bodyColor: "#a1a1aa",
        titleFont: { family: "sans-serif", size: 11 },
        bodyFont: { family: "sans-serif", size: 10 },
      ...
      <div className="space-y-6 text-left font-sans">
        ...
        <div className="flex justify-between items-center border-b border-white/5 pb-4 select-none">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Real-time system telemetry and mapping statistics</p>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="glass-card rounded-xl p-5 bg-[#0d1117]/60 flex flex-col justify-between select-none">
            ...
            <div className="mt-4">
              ...
              <div className="text-[10px] text-slate-500 mt-1.5 uppercase font-mono tracking-wider">Correlated Entries</div>
            </div>
          </div>
          ...
          <div className="glass-card rounded-xl p-5 bg-[#0d1117]/60 flex flex-col justify-between select-none">
            ...
            <div className="mt-4">
              ...
              <div className="text-[10px] text-slate-500 mt-1.5 uppercase font-mono tracking-wider">Background Ingestion</div>
            </div>
          </div>

          <div className="glass-card rounded-xl p-5 bg-[#0d1117]/60 flex flex-col justify-between select-none">
            <div className="flex justify-between items-start text-slate-500">
              <span className="text-xs font-medium uppercase tracking-wider">Incident Cases</span>
              <ShieldAlert size={14} className="text-blue-400" />
            </div>
            <div className="mt-4">
              <div className="text-2xl font-bold text-white leading-none">{caseCount}</div>
              <div className="text-[10px] text-slate-500 mt-1.5 uppercase font-mono tracking-wider">Indexed Cards</div>
            </div>
          </div>

          <div className="glass-card rounded-xl p-5 bg-[#0d1117]/60 flex flex-col justify-between select-none">
            <div className="flex justify-between items-start text-slate-500">
              <span className="text-xs font-medium uppercase tracking-wider">Sensor Health</span>
              <Clock size={14} className="text-emerald-450 animate-pulse" />
            </div>
            <div className="mt-4">
              <div className="text-2xl font-bold text-emerald-450 leading-none">100%</div>
              <div className="text-[10px] text-slate-500 mt-1.5 uppercase font-mono tracking-wider">Operational SLA</div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="glass-card rounded-xl p-5 bg-[#0d1117]/60 space-y-4">
            ...
            <div className="h-56 relative">
              {logs.length === 0 ? (
                <div className="absolute inset-0 flex items-center justify-center text-xs text-slate-500 font-mono">Awaiting telemetry ingestion...</div>
              ) : (
        ...
        {showRaw && (
          <div className="glass-card rounded-xl p-5 bg-[#060814]/80 border border-white/5 space-y-3">
            <div className="flex items-center gap-2 text-xs text-blue-400 font-bold border-b border-white/5 pb-2 font-mono">
