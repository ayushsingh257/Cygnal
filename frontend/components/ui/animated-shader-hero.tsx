...
void main(){gl_Position=position;}`;
    ...
    test(source: string) {
      let result = null;
      const gl = this.gl;
      const MathShader = gl.createShader(gl.FRAGMENT_SHADER)!;
      gl.shaderSource(MathShader, source);
      gl.compileShader(MathShader);

      if (!gl.getShaderParameter(MathShader, gl.COMPILE_STATUS)) {
        result = gl.getShaderInfoLog(MathShader);
      }
      gl.deleteShader(MathShader);
      return result;
    }
